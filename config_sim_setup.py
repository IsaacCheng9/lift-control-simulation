...
class Ui_dialog_config_sim(object):
    def setupUi(self, dialog_config_sim):
        ...
        self.line_edit_num_people.setMaxLength(3)
        self.line_edit_num_people.setObjectName("line_edit_num_people")
        self.grid_layout_config_sim.addWidget(self.line_edit_num_people, 2, 1, 1, 1)
        ...
        self.line_edit_num_floors.setMaxLength(3)
        self.line_edit_num_floors.setObjectName("line_edit_num_floors")
        self.grid_layout_config_sim.addWidget(self.line_edit_num_floors, 1, 1, 1, 1)
        ...
        self.line_edit_lift_capacity.setMaxLength(2)
        self.line_edit_lift_capacity.setObjectName("line_edit_lift_capacity")
        self.grid_layout_config_sim.addWidget(self.line_edit_lift_capacity, 3, 1, 1, 1)
        self.line_edit_ui_delay = QtWidgets.QLineEdit(dialog_config_sim)
        self.line_edit_ui_delay.setMaxLength(4)
        self.line_edit_ui_delay.setObjectName("line_edit_ui_delay")
        self.grid_layout_config_sim.addWidget(self.line_edit_ui_delay, 4, 1, 1, 1)
    ...
    def retranslateUi(self, dialog_config_sim):
        ...
        dialog_config_sim.setWindowTitle(_translate("dialog_config_sim", "New Simulation - Lift Control"))
