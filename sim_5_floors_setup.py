...
class Ui_mwindow_sim_5_floors(object):
    def setupUi(self, mwindow_sim_5_floors):
        ...
        self.grid_layout_sim.addWidget(self.lbl_floor1, 5, 2, 1, 1)
        self.lbl_floor4 = QtWidgets.QLabel(self.layoutWidget)
        self.lbl_floor4.setObjectName("lbl_floor4")
        self.grid_layout_sim.addWidget(self.lbl_floor4, 2, 2, 1, 1)
        ...
        self.grid_layout_sim.addWidget(self.lbl_delivered5, 1, 1, 1, 1)
        self.lbl_floor2 = QtWidgets.QLabel(self.layoutWidget)
        self.lbl_floor2.setObjectName("lbl_floor2")
        self.grid_layout_sim.addWidget(self.lbl_floor2, 4, 2, 1, 1)
        ...
        self.grid_layout_sim.addWidget(self.lbl_waiting1, 5, 0, 1, 1)
        ...
        self.status_bar = QtWidgets.QStatusBar(mwindow_sim_5_floors)
        self.status_bar.setObjectName("status_bar")
        mwindow_sim_5_floors.setStatusBar(self.status_bar)
    ...
    def retranslateUi(self, mwindow_sim_5_floors):
        ...
        self.lbl_delivered3.setText(_translate("mwindow_sim_5_floors", "0"))
        self.lbl_floor1.setText(_translate("mwindow_sim_5_floors", "0"))
        self.lbl_floor4.setText(_translate("mwindow_sim_5_floors", "0"))
        self.lbl_num_delivered2.setText(_translate("mwindow_sim_5_floors", "Number of People Delivered:"))
        self.lbl_delivered5.setText(_translate("mwindow_sim_5_floors", "0"))
        self.lbl_floor2.setText(_translate("mwindow_sim_5_floors", "0"))
        self.lbl_num_waiting.setText(_translate("mwindow_sim_5_floors", "Number of People Waiting:"))
        self.lbl_waiting1.setText(_translate("mwindow_sim_5_floors", "0"))
        self.lbl_lift_floors.setText(_translate("mwindow_sim_5_floors", "Lift Floors:"))
        self.lbl_floor3.setText(_translate("mwindow_sim_5_floors", "0"))
        self.lbl_waiting2.setText(_translate("mwindow_sim_5_floors", "0"))
        self.lbl_waiting4.setText(_translate("mwindow_sim_5_floors", "0"))
        self.lbl_delivered1.setText(_translate("mwindow_sim_5_floors", "0"))
        self.lbl_waiting3.setText(_translate("mwindow_sim_5_floors", "0"))
        self.lbl_floor5.setText(_translate("mwindow_sim_5_floors", "0"))
        self.lbl_delivered4.setText(_translate("mwindow_sim_5_floors", "0"))
        self.lbl_waiting5.setText(_translate("mwindow_sim_5_floors", "0"))
        self.lbl_delivered2.setText(_translate("mwindow_sim_5_floors", "0"))
