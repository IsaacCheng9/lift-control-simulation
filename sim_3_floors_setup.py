...
class Ui_mwindow_sim_3_floors(object):
    def setupUi(self, mwindow_sim_3_floors):
        ...
        mwindow_sim_3_floors.resize(650, 350)
        font = QtGui.QFont()
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(11, 11, 606, 366))
        ...
        self.grid_layout_sim.addWidget(self.lbl_floor_0, 3, 2, 1, 1)
        self.lbl_delivered_2 = QtWidgets.QLabel(self.layoutWidget)
        self.lbl_delivered_2.setObjectName("lbl_delivered_2")
        self.grid_layout_sim.addWidget(self.lbl_delivered_2, 1, 1, 1, 1)
    ...
    def retranslateUi(self, mwindow_sim_3_floors):
        ...
        self.lbl_waiting_floors.setText(_translate("mwindow_sim_3_floors", "Number of People Waiting:"))
        self.lbl_waiting_1.setText(_translate("mwindow_sim_3_floors", "0"))
        self.lbl_floor_2.setText(_translate("mwindow_sim_3_floors", "0"))
        self.lbl_waiting_0.setText(_translate("mwindow_sim_3_floors", "0"))
        self.lbl_delivered_1.setText(_translate("mwindow_sim_3_floors", "0"))
        self.lbl_lift_floors.setText(_translate("mwindow_sim_3_floors", "Lift Floors:"))
        self.lbl_floor_0.setText(_translate("mwindow_sim_3_floors", "0"))
        self.lbl_delivered_2.setText(_translate("mwindow_sim_3_floors", "0"))
        self.lbl_delivered_floors.setText(_translate("mwindow_sim_3_floors", "Number of People Delivered:"))
        self.lbl_waiting_2.setText(_translate("mwindow_sim_3_floors", "0"))
        self.lbl_delivered_0.setText(_translate("mwindow_sim_3_floors", "0"))
        self.lbl_floor_1.setText(_translate("mwindow_sim_3_floors", "0"))
