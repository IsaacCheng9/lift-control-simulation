...
class Ui_mwindow_sim_2_floors(object):
    def setupUi(self, mwindow_sim_2_floors):
        ...
        mwindow_sim_2_floors.resize(525, 325)
        font = QtGui.QFont()
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(11, 11, 491, 291))
        ...
        self.grid_layout_sim.addWidget(self.lbl_floor_1, 1, 2, 1, 1)
        ...
        self.grid_layout_sim.addWidget(self.lbl_delivered_1, 1, 1, 1, 1)
    ...
    def retranslateUi(self, mwindow_sim_2_floors):
        ...
        self.lbl_delivered_floors.setText(_translate("mwindow_sim_2_floors", "Number of People Delivered:"))
        self.lbl_floor_1.setText(_translate("mwindow_sim_2_floors", "0"))
        self.lbl_waiting_1.setText(_translate("mwindow_sim_2_floors", "0"))
        self.lbl_floor_0.setText(_translate("mwindow_sim_2_floors", "0"))
        self.lbl_waiting_0.setText(_translate("mwindow_sim_2_floors", "0"))
        self.lbl_delivered_0.setText(_translate("mwindow_sim_2_floors", "0"))
        self.lbl_lift_floors.setText(_translate("mwindow_sim_2_floors", "Lift Floors:"))
        self.lbl_delivered_1.setText(_translate("mwindow_sim_2_floors", "0"))
        self.lbl_waiting_floors.setText(_translate("mwindow_sim_2_floors", "Number of People Waiting:"))
